...
struct AnimDataProjectListBuilder
    : protected nemesis::Importer<nemesis::LinkedPreprocessLine>,
      public nemesis::StateMachine<AnimDataProjectListBuilder,
                                   nemesis::animdata::ReadingState, void,
                                   const nemesis::Line&>

{
 private:
  enum State { None, Movement, NewProject };
 ...
 public:
  AnimDataProjectListBuilder(
      nemesis::File& file,
      nemesis::animdata::ReadingState start_state = ReadingState::ProjectSize);
